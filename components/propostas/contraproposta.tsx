  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
      <div className="flex items-start justify-between gap-2">
        <div>
          <p className="text-sm font-semibold text-navy-600">Propor novo preço</p>
      ...
      <form action={formAction} className="mt-3 space-y-3">
        ...
        <Input
          ...
          required
          hint={`A proposta atual está em ${formatCurrency(valorAtual, moeda)}.`}
        ...
        <Textarea
          ...
          rows={3}
          maxLength={1000}
          placeholder="Explique por que valor está a ajustar a oferta."
